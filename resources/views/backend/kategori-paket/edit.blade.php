            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Tambah Kategori Paket</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Kategori Paket</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <form action="{{ route('admin.kategori-paket.store') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi">value="{{ $data->deskripsi }}"</textarea>
                                    </div>
